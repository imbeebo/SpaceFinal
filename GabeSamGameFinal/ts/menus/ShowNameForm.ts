module menus {
    ...
    export class ShowName extends createjs.Container {
        ...
        constructor(message: createjs.Text, canvas: HTMLCanvasElement, mainGame: Main, game: createjs.Container) {
            ...
            nameBtn.on("click", (e: createjs.Event) => { this.getName(e); currentMenu = new menus.FrontMenu(canvas, mainGame, message, game); });
            ...
            insBtnText.on("click", (e: createjs.Event) => { this.getName(e); currentMenu = new menus.FrontMenu(canvas, mainGame, message, game); });
